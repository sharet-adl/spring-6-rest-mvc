...
public class CustomerController {
    ...
    public ResponseEntity updateById(@PathVariable("id") UUID customerId, @RequestBody Customer customer) {
        Customer existing = customerService.updateCustomerById(customerId, customer);
    ...
    public ResponseEntity patchById(@PathVariable("id") UUID uuid, @RequestBody Customer customer) {
